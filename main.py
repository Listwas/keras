...
from sklearn.metrics import confusion_matrix, classification_report, recall_score, precision_score, f1_score, balanced_accuracy_score
...
def plot_learning_curves(history, model_name):
    ...
    if recall_key and val_recall_key:
        ...
        axes[2].text(0.5, 0.5, 'Recall metric not found',
                     ha='center', va='center', transform=axes[2].transAxes)
        axes[2].set_title(f'{model_name} - Recall (N/A)')
